...
public class RenderPath extends View
{
	...
	public RenderPath(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		fillBMP = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launcher);
